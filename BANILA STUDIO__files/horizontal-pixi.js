...
if (navigator.userAgent.indexOf("Chrome") !== -1){
	var Ab1imagel="img/one-l.webp";
	var Ab1imaged="img/one-d.webp";
	var Ab2imagel="img/two-l.webp";
	var Ab2imaged="img/two-d.webp";	
	var Ccimagel="img/algorta-l.webp";
	var Ccimaged="img/algorta-d.webp";	
	}else{
	var Ab1imagel="../img/one-l.jpg";
	var Ab1imaged="../img/one-d.jpg";
	var Ab2imagel="../img/two-l.jpg";
	var Ab2imaged="../img/two-d.jpg";	
	var Ccimagel="img/algorta-l.jpg";
	var Ccimaged="img/algorta-d.jpg";			
	} 
